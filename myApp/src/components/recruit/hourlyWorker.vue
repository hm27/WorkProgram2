    ...
    <div>
        ...
        <div>
            <el-table
                ...
                <el-table-column width="80px" label="工作天数">
                    <template slot-scope="scope">
                        {{scope.row.hDays}}
                    </template>
                </el-table-column>
        ...
        <div><!--添加工作岗位的弹窗-->
            <el-dialog title="添加小时工工作岗位" :visible.sync="dialogFormVisible">
                <el-form :model="form">
                    ...
                    <el-form-item label="工作天数" :label-width="formLabelWidth">
                        <el-input v-model="form.hDays" auto-complete="off"></el-input>
                    </el-form-item>
...
//shijianchuo是整数，否则要parseInt转换
                        ...
                        this.form.hDays = data.wrokInfo.hDays;
                    }
                })
            },
            handleDelete(id){
